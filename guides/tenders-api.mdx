---
title: "Public tenders via API: Chile, Brazil, and Mexico"
description: "How to programmatically access public procurement data from Latin American governments — Mercado Público (CL), PNCP (BR), and ComprasMX (MX)."
---
